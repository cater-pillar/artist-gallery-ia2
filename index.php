...
require 'require_php/header.php' ?>
    <?php require 'require_php/nav_en.php' ?>
    </header>
    <div class='slide-down'>
        <div class="container">
            <div class="container-galleries">
                <?php foreach ($projects as $project): ?>
                    <a href=<?php echo 'slide.php?id=' . $project[0] ?>>
                    <div class="container-galleries-project bg bghover" id=<?php echo 'slide' .$project[0] ?>>
                            <img src=<?php echo $project[1] ?> class="project-image">
                            <p class="project-text"><?php echo $project[2] ?></p>
                    </div></a>
                <?php endforeach ?>
            </div>
        </div>
